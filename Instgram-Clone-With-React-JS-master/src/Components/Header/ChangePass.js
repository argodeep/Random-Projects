...
class EditProfilebar extends React.Component {
    ...
    <div className={classes.root}>
      <AppBar position="fixed" className={classes.headerStyle} elevation={0}>
        <Toolbar> 
          ...
          <IconButton aria-label="popup" style={{ padding: '0px 0px' }}>
                <ArrowBackIosRounded  style={{ color: 'gray', padding: 0}}/>
          </IconButton>
          </Link>
          <Typography component="p" className={classes.textTitle}>Change Password</Typography>
  ...
  export default withStyles(styles)(withRouter(EditProfilebar));
